...
* Optimal $\lambda$ Value Chosen: The final $\lambda$ was chosen to maximize cross-validated performance.

* Feature Selection: The model set 28 coefficients to zero (out of 68 total predictors) and resulted in a sparse final model with 40 relevant features.

* Key Interpretive Takeaways (from Non-Zero Coefficients):
** For every standard deviation increase in Academic Pressure, the odds of a student experiencing depression increase by over $\mathbf{200\%}$ (a factor of 3.06).
